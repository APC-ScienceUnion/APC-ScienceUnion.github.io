...
Mathematics did not begin as a fully rigorous discipline. Throughout its history, Bertrand’s paradox and disputes over infinitesimals have both exposed the uncertainty that vague definitions can create. In response, mathematics gradually moved toward formal expression.
{% endnote %}
...
&emsp;&emsp;Whether we are learning mathematics or solving a problem, it is natural to begin by asking, “What is it?”

&emsp;&emsp;A high school student encountering sets for the first time must begin by learning what a set is, even if the answer is only the informal statement that “a set is a whole formed by putting some objects together.” Only after grasping that idea can the student answer other questions about sets or move on to concepts such as mappings.

&emsp;&emsp;The same goes for complex numbers. We first need to know that “a complex number is something of the form $x+iy$, where $x,y$ are real numbers.” Then we ask: what is $i$? What does the plus sign mean here? We keep going until “what is a complex number?” has been answered clearly enough for us to study such things as a complex number’s modulus. If “what is it?” goes unanswered, students remain lost in a fog and naturally cannot move on.

&emsp;&emsp;But what exactly counts as **“*answering the question ‘what is it?’ clearly*”**? At first, this may seem like a question that needs no answer. Human beings can think and understand; once we understand something ourselves, surely the question has been settled. And of course we know whether we truly understand it... or do we?

&emsp;&emsp;Unfortunately, not always. Concepts such as natural numbers, real numbers, elementary probability, and “randomness” are closely tied to everyday life and feel like matters of common sense. Many people believe they understand them perfectly, but that confidence can be an illusion. Consider the classic probability paradox proposed by the French mathematician Joseph Bertrand (1822-1900):
...
&emsp;&emsp;From a modern perspective, our intuitive idea of “uniform randomness” can be summarized roughly by the ***principle of indifference***: cases on an equal footing should be treated alike and assigned equal probabilities. The central challenge of Bertrand’s paradox is that none of its three methods violates that principle. No method is obviously nonrandom, yet they produce entirely different answers. If the calculations are correct, then something must be wrong with our understanding of randomness. Which method is genuinely random—or, more fundamentally, what is randomness?

&emsp;&emsp;We thus discover that even seemingly commonsense concepts can generate paradoxes and force us to ask again what they really mean. The same pattern has recurred throughout the history of mathematics: an answer to “what is it?” is often not final, but one stage in a recurring process of answering, encountering a problem, and answering again. The classic example is calculus, especially the effort to explain what infinitesimals, limits, and continuity are. The next section briefly introduces that history. Some familiarity with calculus will help, but none is essential for following the historical outline.

# A Brief History of the Infinitesimal

&emsp;&emsp;Classical calculus was founded by Isaac Newton (1643-1727) and Gottfried Leibniz (1646-1716). Leibniz held [4, p.187] that an infinitesimal $\mathrm{d}x$ was smaller than any assignable quantity and was itself inassignable. By “assignable,” he meant, roughly, a real number that could be written down, such as $1, 0.3, \sqrt 2$. The concept of the set of positive real numbers had yet to emerge in his time, so this was a natural way for him to express the idea.
...
&emsp;&emsp;This is an important advantage of logical notation. It can eliminate the hidden vagueness and ambiguity of natural languages—the Chinese, English, and other languages people speak—or, put differently, force us to resolve each ambiguity. Although we do not normally write proofs entirely in logical symbols, understanding those symbols also helps us use natural language more precisely, because we consciously or unconsciously “check” whether a statement could be translated into a purely logical language.
...
&emsp;&emsp;In short, translating a natural-language statement into a logical formula can genuinely clarify it. Mathematics education and research today do not ordinarily strip away every trace of natural language and leave an impenetrable book of symbols. When a dispute or ambiguity arises, however, we can—and should make sure that we can—write the statement as a definite logical formula and thereby resolve it.
...
&emsp;&emsp;If this expression is still difficult to read, that is all right. The essential point is that a syllogism is a general, reusable pattern of reasoning. It does not depend on what the particular properties $M,P,S$ happen to be, so we can set their meanings aside and carry out a purely symbolic derivation. The mathematicians in question wanted to generalize this idea much further.
...
&emsp;&emsp;But if definitions and proofs still use natural language, is this not the same as before? No. The key is that the place of natural language in modern mathematics has quietly changed. In early mathematics, natural language served directly as the argument itself and was therefore more likely to rely on visual intuition, physical or geometric meaning, and the context of the problem, or to contain unstated leaps. In modern mathematics, natural language acts more like a compressed representation of reasoning in a formal system. It is accepted only when people believe that it could be translated into a fully formal statement.
