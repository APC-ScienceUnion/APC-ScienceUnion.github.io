---
layout: post
title: 'Hilbert''s Tenth Problem, Part I: Introduction'
...
&emsp;&emsp;This much is familiar territory in popular mathematics, but many accounts stop here. These problems stood at the frontier in 1900, and several remain unsolved today. Most people's mathematical education, meanwhile, focuses on work from the nineteenth century or earlier, developed by giants such as Newton, Euler, Gauss, Cauchy, and Riemann. For most readers, simply understanding what Hilbert's 23 problems ask is difficult, let alone understanding how any of them were solved.

&emsp;&emsp;Fortunately, a few of them are within reach. **Hilbert's Tenth Problem** just barely makes the cut. Let us begin with the question itself. Hilbert's original statement can be rendered roughly as follows:
...
&emsp;&emsp;Some readers may wonder why Hilbert did not simply ask for an "**algorithm**." In 1900, Hilbert did not yet have a formal notion of an algorithm. He already had part of the idea in mind: the "procedure" should stop after finitely many operations, and those operations should be mechanical. But he did not yet know how to characterize computation and algorithms mathematically. That work belonged to Turing and others, and Turing would not be born for another 12 years.

&emsp;&emsp;Hilbert was inclined to assume that such a procedure existed: he did not ask whether it existed, but asked mathematicians to devise it. Only in Turing's era did we learn that not every problem admits an algorithm. Hilbert's Tenth Problem turned out to be one of them: **the algorithm Hilbert requested does not exist**.
