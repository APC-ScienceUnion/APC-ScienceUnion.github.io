...
&emsp;&emsp;At first sight, the point of this construction may be obscure. The key is that S is a subset of the natural numbers, which means that tools from computability theory can be brought to bear on it.
