function dark() {
    ...
    function f() {
      (n = window.innerWidth), (e = window.innerHeight), (i =
        0.216 * n), s.setAttribute("width", n), s.setAttribute("height", e);
    }
    function u() {
      h.clearRect(0, 0, n, e);
    ...
    function y() {
      (this.reset = function() {
        ...
        if ((h.beginPath(), this.giant))
          (h.fillStyle = "rgba(" + a + "," + this.opacity + ")"), h.arc(
            this.x,
            this.y,
            2,
            0,
          ...
          (h.fillStyle = "rgba(" + d + "," + this.opacity + ")"), h.arc(
            this.x,
            this.y,
            1.5,
            0,
          ...
          (h.fillStyle = "rgba(" + r + "," + this.opacity + ")"), h.rect(
            this.x,
            this.y,
            this.r,
            this.r
    ...
    f(), window.addEventListener("resize", f, !1), (function() {
      ...
      (document.getElementsByTagName("html")[0].getAttribute("data-theme") ==
        ...
        "light") && u(), window.requestAnimationFrame(t);
    })();
  }
  dark();
